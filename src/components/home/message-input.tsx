...
const MessageInput = () => {
  ...
  const divRef = ref as React.RefObject<HTMLDivElement>; // Cast to `RefObject<HTMLDivElement>`
  ...
  return (
    <div className='bg-gray-primary p-2 flex gap-4 items-center'>
      <div className='relative flex gap-2 ml-2'>
        ...
        <div ref={divRef} onClick={() => setIsComponentVisible(true)} className='cursor-pointer'>
          {isComponentVisible && (
            <EmojiPicker
              theme={Theme.DARK}
